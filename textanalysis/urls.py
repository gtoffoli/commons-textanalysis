...
urlpatterns = [
    ...
    url(r"^nounchunks/(?P<file_key>[\w\d-]+)/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", views.text_nounchunks, name="text_nounchunks_3"),
    url(r"^nounchunks/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", views.text_nounchunks, name="text_nounchunks_2"),
    ...
    url(r"^dependency/(?P<file_key>[\w\d-]+)/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", views.text_dependency, name="text_dependency_3"),
    url(r"^dependency/(?P<obj_type>[\w\.-]+)/(?P<obj_id>[\d-]+)/$", views.text_dependency, name="text_dependency_2"),
